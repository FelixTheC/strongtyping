...
from strongtyping.strong_typing import P as P, T as T, TypeMisMatch as TypeMisMatch
...
def match_docstring(_func: Incomplete | None = ..., *, excep_raise: type[TypeMisMatch] = ..., cache_size: int = ..., subclass: bool = ..., severity: str = ..., **kwargs): ...
def match_class_docstring(_cls: Incomplete | None = ..., *, excep_raise: type[TypeError] = ..., cache_size: int = ..., severity: str = ..., **kwargs): ...
def getter(func): ...
def setter(func): ...
